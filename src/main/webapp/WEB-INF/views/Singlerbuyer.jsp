...
<td><a href="${pageContext.request.contextPath}/singleBuyer/buyerInvoices/${buyer.id}">Number of ${buyer.numberOfInvoice}</a></td>
<td>${buyer.fileName}</td>
<td><a href="${pageContext.request.contextPath}/singleBuyer/delete/${buyer.id}">Delete</a></td>
</tr>
<%-- </c:forEach> --%>
</tbody>
</table>
