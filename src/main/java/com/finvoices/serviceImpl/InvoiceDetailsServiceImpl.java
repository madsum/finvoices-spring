...
@Service
public class InvoiceDetailsServiceImpl implements InvoiceDetailsDAO {
	...
	public InvoiceDetailsServiceImpl(SessionFactory sessionFactory) {
	...
	public List<InvoiceDetails> getByBuyerId(int id){
		String hql = "from InvoiceDetails where buyerPartyDetails=" + id;
		Query query = sessionFactory.getCurrentSession().createQuery(hql);
