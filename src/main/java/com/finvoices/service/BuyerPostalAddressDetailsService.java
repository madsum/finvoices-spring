...
@Service
public class BuyerPostalAddressDetailsService implements BuyerPostalAddressDetailsDAO {
	
	@Autowired
	private SessionFactory sessionFactory;

	public BuyerPostalAddressDetailsService() {
		
	}
	
	public BuyerPostalAddressDetailsService(SessionFactory sessionFactory) {
